...
public class Extra4 {
    ...
    public static void main(String[] args) {
        ...
        SimuladorService sc=new SimuladorService();
        
        ArrayList<Alumno> ListaAlumnosCompleta = new ArrayList<>(sc.crearAlumnos());
        
        sc.imprimir(ListaAlumnosCompleta);
        
        //Prueba Luis
        
        sc.mostrarVOtdados(sc.votacion(ListaAlumnosCompleta));
        sc.recuentoV(ListaAlumnosCompleta);
        sc.facilitadores(ListaAlumnosCompleta);
        
    }
    
}
/**
 Desarrollar un simulador del sistema de votación de facilitadores en Egg El sistema de votación de Egg tiene una clase llamada 
